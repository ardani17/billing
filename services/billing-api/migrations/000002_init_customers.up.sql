-- Migrasi: membuat tabel customers dengan Row Level Security (RLS).
-- Tabel customers adalah contoh tabel tenant-scoped yang mendemonstrasikan
-- pola isolasi multi-tenant menggunakan RLS di PostgreSQL.
