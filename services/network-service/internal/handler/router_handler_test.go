...
// Menggunakan mock RouterUsecase dan Fiber app.Test() untuk HTTP testing.
...
// =============================================================================
// Mock RouterUsecase — mengembalikan respons yang sudah ditentukan
// =============================================================================

// mockRouterUsecase adalah mock implementasi domain.RouterUsecase untuk testing.
...
// =============================================================================
// Helper — setup test Fiber app dengan tenant middleware bypass
// =============================================================================
...
func setupTestApp(uc domain.RouterUsecase) *fiber.App {
	...
	// Middleware test: set tenant_id di Go context seperti yang dilakukan
...
// parseAPIResponse mem-parse body respons ke domain.APIResponse.
...
// =============================================================================
// Test Create — POST /api/v1/mikrotik/routers
// =============================================================================

// TestCreate_Success memverifikasi request valid menghasilkan 201.
...
// TestCreate_InvalidBody memverifikasi body tidak valid menghasilkan 422.
...
// =============================================================================
// Test GetByID — GET /api/v1/mikrotik/routers/:id
// =============================================================================
...
// =============================================================================
// Test Update — PUT /api/v1/mikrotik/routers/:id
// =============================================================================

// TestUpdate_Success memverifikasi update valid menghasilkan 200.
...
// TestUpdate_InvalidTransition memverifikasi transisi status tidak valid menghasilkan 422.
...
// =============================================================================
// Test Delete — DELETE /api/v1/mikrotik/routers/:id
// =============================================================================

// TestDelete_Success memverifikasi delete berhasil menghasilkan 204.
...
// TestDelete_NotFound memverifikasi delete router tidak ditemukan menghasilkan 404.
...
// =============================================================================
// Test List — GET /api/v1/mikrotik/routers
// =============================================================================

// TestList_Pagination memverifikasi list dengan paginasi menghasilkan 200.
...
// =============================================================================
// Test TestConnection — POST /api/v1/mikrotik/routers/:id/test
// =============================================================================
...
// =============================================================================
// Test Reboot — POST /api/v1/mikrotik/routers/:id/reboot
// =============================================================================

// TestReboot_ValidConfirmation memverifikasi konfirmasi valid menghasilkan 200.
...
// TestCreate_MalformedJSON memverifikasi JSON tidak valid menghasilkan 400.
