// router_handler.go menangani HTTP request untuk manajemen router MikroTik.
...
// RouterHandler menangani HTTP request untuk operasi router MikroTik.
...
// Create menangani POST /api/v1/mikrotik/routers.
// Parse body, validasi, extract tenant_id, lalu buat router baru.
...
// Update menangani PUT /api/v1/mikrotik/routers/:id.
// Parse body, validasi, lalu update data router.
...
// Delete menangani DELETE /api/v1/mikrotik/routers/:id.
// Soft-delete router dan tutup pool koneksi.
...
// Parse query params (page, page_size, status, search) dan return paginated list.
func (h *RouterHandler) List(c *fiber.Ctx) error {
	...
	// Parse query params dengan default values
...
// Parse body, validasi konfirmasi nama, lalu kirim perintah reboot.
