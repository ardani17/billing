// session_handler.go menangani HTTP request untuk manajemen PPPoE active sessions.
...
// SessionHandler menangani HTTP request untuk operasi PPPoE session.
...
// mapError memetakan domain error ke HTTP error response untuk session operations.
