...
// Menggunakan mock ProvisioningManager dan Fiber app.Test().
// Validasi: request validation, response format, error mapping (400/404/409/422/502/504).
package handler
...
// =============================================================================
// Helper — setup test Fiber app untuk Provisioning
// =============================================================================
...
func setupProvTestApp(mgr domain.ProvisioningManager) *fiber.App {
	...
	// Middleware test: set tenant_id dan username di context
...
// =============================================================================
// Test ProvisionONT — POST /api/v1/olt/provisioning/ont
// =============================================================================
...
// =============================================================================
// Test ListONTs — GET /api/v1/olt/provisioning/onts
// =============================================================================
...
// =============================================================================
// Test GetSettings / UpdateSettings
// =============================================================================
...
// =============================================================================
// Test BulkTemplate — GET /api/v1/olt/provisioning/bulk/template
// =============================================================================
...
// =============================================================================
// Test BulkExecute — POST /api/v1/olt/provisioning/bulk/execute
// =============================================================================
