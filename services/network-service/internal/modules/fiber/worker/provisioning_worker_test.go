...
func (m *mockProvisioningManager) PreviewProvisionONT(_ context.Context, _ string, _ domain.ProvisionONTRequest) (*domain.ProvisioningDryRun, error) {
	return nil, nil
}
...
// **Memvalidasi: Kebutuhan 7.2, 13.1**
// =============================================================================
