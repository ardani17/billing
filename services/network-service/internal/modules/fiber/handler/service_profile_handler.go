// service_profile_handler.go menangani HTTP permintaan untuk manajemen service profile per OLT.
package handler
...
// ServiceProfileHandler menangani HTTP permintaan untuk operasi service profile.
...
// Parsing body, validasi, atur OLT ID dari path, lalu buat service profile baru.
...
// Parsing body, validasi, lalu perbarui data service profile.
...
// Soft-hapus service profile (cek tidak ada ONT aktif yang menggunakan).
...
// mapError memetakan domain error service profile ke HTTP error respons.
