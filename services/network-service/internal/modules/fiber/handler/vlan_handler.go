// vlan_handler.go menangani HTTP permintaan untuk manajemen VLAN per OLT.
package handler
...
// VLANHandler menangani HTTP permintaan untuk operasi VLAN.
...
// Parsing body, validasi, atur OLT ID dari path, lalu buat VLAN baru.
...
// Parsing body, validasi, lalu perbarui data VLAN.
...
// Soft-hapus VLAN (cek tidak ada ONT aktif yang menggunakan).
...
// mapError memetakan domain error VLAN ke HTTP error respons.
