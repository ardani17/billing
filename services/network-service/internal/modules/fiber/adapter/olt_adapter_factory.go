...
// Compile-time cek: pastikan oltAdapterFactory mengimplementasikan domain.OLTAdapterFactory.
...
func (f *oltAdapterFactory) CreateAdapter(
	...
	if !f.registry.IsKnownBrand(brand) {
