...
// =============================================================================
// Tes Cases - HandleUnregisteredONT (Auto-Provisioning)
// =============================================================================
...
func TestHandleUnregisteredONT_AutoDisabled(t *testing.T) {
	...
	// Settings: auto-provisioning disabled (bawaan)
...
func TestHandlePortMigration_AutoDisabled(t *testing.T) {
	...
	// Auto-port-migration disabled (bawaan)
	ontRepo.onts["ont-001"] = &domain.ONT{
		ID:           "ont-001",
		TenantID:     "tenant-001",
		OLTID:        "olt-001",
