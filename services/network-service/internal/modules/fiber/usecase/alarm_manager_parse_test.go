...
func TestParseTrapPDU_ClearEvent(t *testing.T) {
	pdus := []gosnmp.SnmpPDU{
		{Name: ".1.3.6.1.4.1.3902.1.100", Value: []byte("ONT Loss of Signal clear")},
	}
	alarm := parseTrapPDU(pdus, "10.0.0.1")
	if alarm == nil {
		t.Fatal("expected alarm, got nil")
	...
	if alarm.Severity != domain.SeverityClear {
		t.Fatalf("expected clear severity, got %q", alarm.Severity)
	}
}

// =============================================================================
// Tes: parseTrapPDU - Dying Gasp
// =============================================================================
...
// =============================================================================
// Tes: parseTrapPDU - PON Port Down
// =============================================================================
...
// =============================================================================
// Tes: parseTrapPDU - High Temperature
// =============================================================================
...
// =============================================================================
// Tes: parseTrapPDU - Signal Degraded
// =============================================================================
