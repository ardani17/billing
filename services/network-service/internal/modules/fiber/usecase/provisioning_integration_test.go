...
// =============================================================================
// Integration Tes 1: Full Provisioning Lifecycle
// **Memvalidasi: Kebutuhan 1.2, 3.1, 7.1, 9.1, 10.1, 14.12**
//
// =============================================================================
...
// =============================================================================
// Integration Tes 2: Bulk Provisioning Flow
// **Memvalidasi: Kebutuhan 5.1, 14.12**
//
// =============================================================================
...
// =============================================================================
// Integration Tes 3: Port Migration Detection + Confirmation
// **Memvalidasi: Kebutuhan 11.5**
//
// Alur: detect port migration -> terbitkan event -> confirm migration
// =============================================================================
