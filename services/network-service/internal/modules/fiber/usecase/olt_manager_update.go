// File ini berisi implementasi GetByID, Perbarui, Hapus, dan List untuk OLT Manager.
package usecase
...
// Perbarui memperbarui data OLT. Encrypt kredensial baru jika diberikan.
func (m *oltManager) Update(ctx context.Context, id string, req domain.UpdateOLTRequest) (*domain.OLTResponse, error) {
	...
	// Perbarui field-field yang diberikan
...
// Hapus melakukan hapus lunak OLT dan menghapus dari pemeriksa kesehatan.
