...
func (pm *provisioningManager) HandleUnregisteredONT(ctx context.Context, oltID string, ont domain.UnregisteredONT) error {
	...
	if provErr != nil {
		// Auto-provisioning gagal, terbitkan event
	...
	// Auto-provisioning berhasil, terbitkan event
...
// Terbitkan event, cek auto_port_migration_enabled, perbarui DB jika enabled.
