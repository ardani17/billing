...
// Compile-time cek: oltManager harus mengimplementasikan domain.OLTManager.
...
type oltManager struct {
	...
	healthChecker domain.OLTHealthChecker // opsional, di-atur setelah konstruksi
}
...
// SetHealthChecker mengatur pemeriksa kesehatan setelah konstruksi.
