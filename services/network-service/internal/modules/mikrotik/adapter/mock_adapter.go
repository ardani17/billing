...
// MockAdapter mengimplementasikan RouterOSAdapter dengan respons simulasi.
package adapter
...
// Execute menjalankan perintah RouterOS dan mengembalikan respons simulasi.
		...
		return []map[string]string{
			{
				...
				"write-sect-total":        "2048",
				"build-time":              "Oct/20/2023 09:12:33",
			},
		}, nil
...
func (m *MockAdapter) GetSystemResource(_ context.Context) (*SystemResource, error) {
	return &SystemResource{
		...
		TotalHDDSpace:        16 * 1024 * 1024,
		FreeHDDSpace:         10 * 1024 * 1024,
		WriteSectSinceReboot: 1024,
		WriteSectTotal:       2048,
		Uptime:               3888000, // 45 hari dalam detik
		Architecture:         "mmips",
		BuildTime:            "Oct/20/2023 09:12:33",
