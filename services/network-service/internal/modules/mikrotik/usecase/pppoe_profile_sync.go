...
// SyncProfile membuat atau perbarui PPPoE profile di semua router dengan service_type pppoe.
...
func (m *pppoeManager) SyncProfile(ctx context.Context, profile *domain.PPPoEProfile) error {
	...
	// Bangun PPPoEProfileParams dari profile entity
...
// Coba buat dulu, jika sudah ada (error) maka perbarui.
