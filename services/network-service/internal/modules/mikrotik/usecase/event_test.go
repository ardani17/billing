...
func routerGen(t *rapid.T) *domain.Router {
	...
	// Buat LastOnlineAt - kadang nil, kadang ada
...
// yang benar, dan semua required payload field untuk tipe event tersebut.
//
// **Memvalidasi: Kebutuhan 10.1, 10.2, 10.3, 10.4**
func TestProperty_EventPayloadCompletenessWithCorrelationID(t *testing.T) {
	t.Run("router_offline_event", func(t *testing.T) {
		rapid.Check(t, func(rt *rapid.T) {
			...
			// Terbitkan event router offline
	...
	t.Run("router_unexpected_reboot_event", func(t *testing.T) {
		rapid.Check(t, func(rt *rapid.T) {
			...
			// Buat uptime: prevUptime > currUptime (reboot terdeteksi)
			...
			// Terbitkan event unexpected reboot
