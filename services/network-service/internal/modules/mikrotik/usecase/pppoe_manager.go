...
// Menangani lifecycle lengkap: buat, isolir, un-isolir, suspend, package change, sync.
type PPPoEManager interface {
	...
	// SyncProfile membuat atau perbarui PPPoE profile di semua router.
...
// Mengelola lifecycle PPPoE user: buat, isolir, un-isolir, suspend, sync.
...
// getRouterAndPool mengambil router dari repositori, mendekripsi password,
