...
import (
	...
	"github.com/ispboss/ispboss/services/network-service/internal/modules/mikrotik/adapter"
)
...
// TestIntegration_HandleCustomerActivated_Success - alur penuh: event -> manager -> adapter -> DB -> event keluar.
...
func TestIntegration_HandleIsolir_Success(t *testing.T) {
	...
	// Verifikasi sequence: minimal 3 commands (atur secret, print active, add nat rule)
