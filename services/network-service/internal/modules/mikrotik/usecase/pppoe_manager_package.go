...
func (m *pppoeManager) HandlePackageChanged(ctx context.Context, payload domain.PackageChangedPayload) error {
	...
	// Resolve new profile dari profileRepo atau cadangan metadata dari billing-api.
	...
	// Perbarui PPPoE secret profile -> /ppp/secret/atur profile=new_profile_name
	...
	// Jika use_simple_queue enabled, perbarui bandwidth limits
	...
	// Perbarui PPPoE user di DB dengan profile_name baru
