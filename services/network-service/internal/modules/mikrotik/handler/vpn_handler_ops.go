// vpn_handler_ops.go menangani HTTP permintaan untuk operasi VPN tunnel.
...
// Menghasilkan RouterOS script (.rsc) dan kembalikan sebagai text/plain dengan Content-Disposition.
