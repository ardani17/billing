// vpn_handler.go menangani HTTP permintaan untuk manajemen VPN tunnel.
// Termasuk: CRUD tunnel, validasi permintaan, dan error mapping.
package handler
...
// VPNHandler menangani HTTP permintaan untuk operasi VPN tunnel.
...
// Parsing body, validasi, extract tenant_id, lalu buat tunnel baru.
...
// Parsing body, validasi, lalu perbarui data tunnel.
...
// Soft-hapus tunnel dan kembalikan 204 No Content.
