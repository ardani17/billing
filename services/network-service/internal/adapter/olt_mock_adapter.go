...
// Compile-time check: pastikan MockOLTAdapter mengimplementasikan domain.OLTAdapter.
...
// Ping selalu berhasil (return nil) karena mock tidak memerlukan koneksi jaringan.
