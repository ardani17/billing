// Package adapter menyediakan implementasi VPNCommandBuilder untuk RouterOS.
...
// NewVPNCommandBuilder membuat instance baru VPNCommandBuilder.
func NewVPNCommandBuilder() domain.VPNCommandBuilder {
	return &vpnCommandBuilder{}
}
