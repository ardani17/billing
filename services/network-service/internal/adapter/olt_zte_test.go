...
// --- Mock SNMP Connector untuk unit test ---

// mockSNMPConnector adalah mock untuk domain.SNMPConnector.
...
// --- Test Response Mapping dari SNMP ke Domain Types ---
