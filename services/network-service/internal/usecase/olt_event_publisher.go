...
// File ini mengimplementasikan OLTEventPublisher untuk publish event OLT ke Redis queue.
package usecase
...
// Compile-time check: oltEventPublisher harus mengimplementasikan domain.OLTEventPublisher.
...
// Generate correlation_id jika belum diset pada payload.
