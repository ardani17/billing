...
// Menggunakan mock dependencies yang sudah ada di file test lain.
package usecase
...
// =============================================================================
// Mock terintegrasi — merekam semua interaksi lintas komponen
// =============================================================================

// integOLTRepo adalah mock repo yang mendukung semua operasi OLT untuk integration test.
...
func (p *oltIntegEventPub) PublishONTProvisioned(_ context.Context, _ domain.ONTProvisionedPayload) error { return nil }
func (p *oltIntegEventPub) PublishONTDecommissioned(_ context.Context, _ domain.ONTDecommissionedPayload) error { return nil }
func (p *oltIntegEventPub) PublishONTAutoProvisioned(_ context.Context, _ domain.ONTAutoProvisionedPayload) error { return nil }
func (p *oltIntegEventPub) PublishONTAutoProvisionFailed(_ context.Context, _ domain.ONTAutoProvisionFailedPayload) error { return nil }
func (p *oltIntegEventPub) PublishONTPortMigrated(_ context.Context, _ domain.ONTPortMigratedPayload) error { return nil }
