...
// File ini berisi fungsi perbandingan ONT set untuk sync engine.
...
// ontCompareResult berisi hasil perbandingan dua set ONT.
...
// compareONTSets membandingkan dua set ONT (dari OLT dan dari DB).
// Mengklasifikasikan setiap ONT ke tepat satu kategori berdasarkan serial number.
// OLT = source of truth untuk data fisik.
//
// Klasifikasi:
