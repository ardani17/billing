// Package usecase — property test dan unit tests untuk sync engine.
// Menguji compareONTSets (pure function) dan SyncOLT dengan mock adapter.
package usecase
...
// =============================================================================
// Feature: olt-management, Property 7: Sync Comparison Correctness
// =============================================================================

// TestProperty_SyncComparisonCorrectness memverifikasi bahwa untuk sembarang
// dua set ONT records, compareONTSets mengklasifikasikan setiap ONT ke tepat
// satu kategori. Total count semua kategori sama dengan union kedua set.
...
func TestProperty_SyncComparisonCorrectness(t *testing.T) {
	rapid.Check(t, func(t *rapid.T) {
		// Generate set ONT dari OLT dengan serial number unik
		oltCount := rapid.IntRange(0, 20).Draw(t, "oltCount")
		oltONTs := generateONTSet(t, "olt", oltCount)

		// Generate set ONT dari DB — sebagian overlap dengan OLT
		...
		// Properti 1: Total count semua kategori = union kedua set
		...
		// Properti 5: Updated dan Synced hanya berisi ONT yang ada di kedua set
...
// =============================================================================
// Helper generators untuk property test
// =============================================================================
...
// countUnion menghitung jumlah serial number unik dari gabungan dua set.
...
// serialNumberSet membuat set serial number dari slice ONTStatus.
