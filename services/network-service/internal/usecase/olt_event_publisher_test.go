...
// payload SHALL berisi non-empty correlation_id, valid olt_id, non-empty olt_name,
// dan valid tenant_id. Alarm events SHALL tambahan berisi non-empty alarm_type
// dan valid severity.
// =============================================================================
...
// oltBrandGen menghasilkan brand OLT acak yang valid.
func oltBrandGen() *rapid.Generator[string] {
	return rapid.SampledFrom([]string{"zte", "huawei", "fiberhome", "vsol", "hsgq"})
}

// alarmTypeGen menghasilkan alarm type acak yang valid.
...
// severityGen menghasilkan severity acak yang valid.
...
// OLT event payload, semua required fields non-empty dan correlation_id terisi.
//
// **Validates: Requirements 17.1, 17.2, 17.3, 17.4**
