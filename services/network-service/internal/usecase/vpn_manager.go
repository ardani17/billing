...
// Mengelola lifecycle VPN tunnel: create, configure, test, monitor, delete.
type vpnManager struct {
	...
	cmdBuilder  domain.VPNCommandBuilder
...
// DeleteTunnel melakukan soft-delete tunnel.
...
func (m *vpnManager) DeleteTunnel(ctx context.Context, id string) error {
	...
	// Soft-delete tunnel di database
