...
// =============================================================================
// Test fixtures dan helpers untuk VPN Script Generator
// =============================================================================
...
// =============================================================================
// Feature: mikrotik-vpn, Property 3: Script generation completeness per protocol
// =============================================================================
...
func TestVPNProperty_ScriptGenerationCompleteness(t *testing.T) {
	...
	// Sub-test per protokol untuk kejelasan output
	...
	t.Run("L2TP_IPSec", func(t *testing.T) {
		rapid.Check(t, func(rt *rapid.T) {
			...
			// Harus mengandung username dan use-ipsec=yes
...
// =============================================================================
// Feature: mikrotik-vpn, Property 4: Script security — no server private key exposure
// =============================================================================
...
// =============================================================================
// Helper functions untuk assertions
// =============================================================================
