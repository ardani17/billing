// Package usecase — Unit tests untuk DecommissionONT: manual, event-driven, CLI failure.
package usecase
...
// TestDecommissionONT_NotFound memverifikasi error saat ONT tidak ditemukan.
