...
// statusCountsGen menghasilkan map status counts acak untuk property test.
...
func TestProperty_OLTStatusSummaryInvariant(t *testing.T) {
	rapid.Check(t, func(rt *rapid.T) {
		...
		// Buat mock repo dengan counts yang di-generate
		repo := newMockOLTRepo()
		...
		// Verifikasi setiap bucket sesuai input
