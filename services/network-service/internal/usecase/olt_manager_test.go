...
// =============================================================================
// Mock implementations untuk testing OLT Manager
// =============================================================================

// mockOLTRepo adalah mock implementasi domain.OLTRepository.
...
// mockAlarmRepo adalah mock implementasi domain.AlarmRepository.
...
// mockEncryptor adalah mock implementasi domain.CredentialEncryptor.
...
// mockOLTAdapter adalah mock implementasi domain.OLTAdapter.
...
// mockOLTAdapterFactory adalah mock implementasi domain.OLTAdapterFactory.
...
// mockCLIConnector adalah mock implementasi domain.CLIConnector.
...
// mockSNMPConnector adalah mock implementasi domain.SNMPConnector.
...
// mockOLTEventPublisher adalah mock implementasi domain.OLTEventPublisher.
...
// mockHealthChecker adalah mock implementasi domain.OLTHealthChecker.
...
// =============================================================================
// Helper untuk membuat OLT Manager dengan mock dependencies
// =============================================================================
...
func TestOLTManager_Create_AutoDetectSuccess(t *testing.T) {
	...
	// Verifikasi health checker dipanggil
	if len(hc.addedOLTs) != 1 {
		t.Errorf("health checker AddOLT tidak dipanggil: got %d calls", len(hc.addedOLTs))
	}
...
func TestOLTManager_Update_InvalidStatusTransition(t *testing.T) {
	...
	// offline → offline bukan transisi valid
...
func TestOLTManager_Delete(t *testing.T) {
	...
	// Verifikasi health checker RemoveOLT dipanggil
	if len(hc.removedOLTs) != 1 || hc.removedOLTs[0] != "olt-001" {
		t.Errorf("health checker RemoveOLT tidak dipanggil dengan benar: %v", hc.removedOLTs)
	}
}
