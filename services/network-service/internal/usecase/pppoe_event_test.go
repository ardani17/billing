...
// =============================================================================
// Generators — reusable generators untuk PPPoE event property tests
// =============================================================================

// validOperations adalah daftar operasi PPPoE yang valid.
var validOperations = []string{"create", "isolir", "un_isolir", "suspend", "package_change"}

// validStatuses adalah daftar status command result yang valid.
...
// operationGen menghasilkan operasi PPPoE yang valid secara acak.
func operationGen() *rapid.Generator[string] {
	return rapid.SampledFrom(validOperations)
}

// statusGen menghasilkan status command result yang valid secara acak.
...
// commandResultPayloadGen menghasilkan CommandResultPayload acak yang valid.
...
// =============================================================================
// Feature: mikrotik-pppoe, Property 8: Command result payload completeness
// =============================================================================
...
// Operation harus salah satu dari: "create", "isolir", "un_isolir", "suspend",
// "package_change". Status harus salah satu dari: "success", "failed",
// "failed_permanent".
//
...
func TestProperty_CommandResultPayloadCompleteness(t *testing.T) {
	rapid.Check(t, func(rt *rapid.T) {
		...
		// Generate payload acak yang valid
		...
		// Verifikasi required fields non-empty
		...
		// Verifikasi operation adalah salah satu nilai yang valid
		validOp := false
		...
		// Verifikasi status adalah salah satu nilai yang valid
		validSt := false
		...
		// Verifikasi payload values match input
...
// =============================================================================
// Feature: mikrotik-pppoe, Property 9: Error message safety
// =============================================================================

// isErrorMessageSafe memeriksa bahwa error message tidak mengandung data sensitif.
// Mengembalikan true jika error message aman (tidak mengandung password atau encryption key).
...
func TestProperty_ErrorMessageSafety(t *testing.T) {
	rapid.Check(t, func(rt *rapid.T) {
		...
		// Generate error messages yang mungkin mengandung data sensitif
		// Kita test helper function isErrorMessageSafe secara langsung
		safeMessages := []string{
		...
		// Property: untuk sembarang error message acak yang TIDAK mengandung
		// password atau encryption key, isErrorMessageSafe harus return true
