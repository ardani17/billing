...
// =============================================================================
// Mock implementations untuk alarm manager tests
// =============================================================================

// amAlarmRepo merekam panggilan Create, List, dan PurgeOlderThan.
...
func (r *amAlarmRepo) ClearAlarm(_ context.Context, _ string) error { return nil }
...
func (r *amOLTRepo) GetActiveOLTs(_ context.Context) ([]*domain.OLT, error)  { return nil, nil }
...
func (p *amEventPub) PublishONTProvisioned(_ context.Context, _ domain.ONTProvisionedPayload) error { return nil }
func (p *amEventPub) PublishONTDecommissioned(_ context.Context, _ domain.ONTDecommissionedPayload) error { return nil }
func (p *amEventPub) PublishONTAutoProvisioned(_ context.Context, _ domain.ONTAutoProvisionedPayload) error { return nil }
func (p *amEventPub) PublishONTAutoProvisionFailed(_ context.Context, _ domain.ONTAutoProvisionFailedPayload) error { return nil }
func (p *amEventPub) PublishONTPortMigrated(_ context.Context, _ domain.ONTPortMigratedPayload) error { return nil }

// amEncryptor — mock enkripsi/dekripsi untuk testing.
...
// amAdapter — mock adapter yang mengembalikan alarm yang dikonfigurasi.
...
func (a *amAdapter) AddONT(_ context.Context, _ domain.AddONTParams) (*domain.ProvisioningResult, error) { return nil, nil }
func (a *amAdapter) RemoveONT(_ context.Context, _ domain.RemoveONTParams) (*domain.ProvisioningResult, error) { return nil, nil }
func (a *amAdapter) AddServicePort(_ context.Context, _ domain.AddServicePortParams) (*domain.ProvisioningResult, error) { return nil, nil }
func (a *amAdapter) RemoveServicePort(_ context.Context, _ domain.RemoveServicePortParams) (*domain.ProvisioningResult, error) { return nil, nil }
func (a *amAdapter) RebootONT(_ context.Context, _ domain.RebootONTParams) (*domain.ProvisioningResult, error) { return nil, nil }
func (a *amAdapter) GetUnregisteredONTs(_ context.Context) ([]domain.UnregisteredONT, error) { return nil, nil }

// amFactory — mock factory yang mengembalikan adapter tertentu.
...
// =============================================================================
// Helper — membuat alarmManager instance untuk testing
// =============================================================================
