...
// Jika berhasil: update status ke "connected", catat last_handshake_at dan latency_ms.
...
func (m *vpnManager) TestConnection(ctx context.Context, id string) (*domain.VPNTestResult, error) {
	...
	// Koneksi berhasil — update status ke connected
	now := time.Now()
